            ...
            node.find("> *").each(function(){
                switch(this.nodeName){
                    ...
                    case "instance_geometry":
                        ...
                        glQuery.object.add(object.id, object.type, "test", object.geometry.mesh, object.material[object.geometry.mesh.materialUrl].material, {"mvMat4":object.modelViewMatrix,"position":object.position});
                        break;
                    case "instance_light":
                        object.type = "light";
                        object.light = glQuery.collada.light.instanceLight(this.getAttribute("url"), self);
                        glQuery.light.add(object.id, "test", object.light, {"mvMat4":object.modelViewMatrix,"position":object.position});
                        break;
